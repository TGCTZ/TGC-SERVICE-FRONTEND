    ...
    public function up(): void
    {
        ...
        Schema::create(
            ...
            static function (Blueprint $table) use (
                ...
                $table->foreign($pivotPermission)->references(
                    'id'
                ) // permission id
                    ->on($tableNames['permissions'])->cascadeOnDelete();
                if ($teams) {
                    $table->unsignedBigInteger(
                        $columnNames['team_foreign_key']
                    );
        ...
        Schema::create(
            ...
            static function (Blueprint $table) use (
                ...
                $table->foreign($pivotRole)->references('id') // role id
                    ->on($tableNames['roles'])->cascadeOnDelete();
                if ($teams) {
                    $table->unsignedBigInteger(
                        $columnNames['team_foreign_key']
                    );
