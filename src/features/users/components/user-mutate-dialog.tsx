...
import { rolesQuery } from '@/features/roles/data/roles-api'
...
function buildSchema(isEdit: boolean) {
  return z
    .object({
      ...
      user_status_id: z.coerce.number().optional(),
  ...
  useEffect(() => {
    ...
    if (currentRow) {
      form.reset({
        ...
        user_status_id: currentRow.user_status_id ?? undefined,
        gender_id: currentRow.gender_id ?? undefined,
        bio: currentRow.bio ?? '',
