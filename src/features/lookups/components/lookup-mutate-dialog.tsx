...
import { type LookupConfig, type LookupRow } from '../data/lookup-config'
import { createLookupRow, updateLookupRow } from '../data/lookups-api'
        ...
        <DialogFooter>
          {readOnly ? (
            <ViewFooterActions
              ...
              primary={
                onRequestEdit && (
                  <Can permission={`${config.resource}.update`}>
