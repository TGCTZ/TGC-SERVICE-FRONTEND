...
const listSchema = paginatedSchema(productSchema)
...
export const lookupQueryOptions = (resource: string) =>
  queryOptions({
    queryKey: ['lookup', resource],
    queryFn: () => fetchLookup(resource),
    staleTime: 10 * 60 * 1000,
  })

export const productCategoriesQuery = () =>
  lookupQueryOptions('product-categories')
export const brandsQuery = () => lookupQueryOptions('brands')
export const productStatusesQuery = () => lookupQueryOptions('product-statuses')
export const unitOfMeasuresQuery = () => lookupQueryOptions('unit-of-measures')
export const tagsQuery = () => lookupQueryOptions('tags')
