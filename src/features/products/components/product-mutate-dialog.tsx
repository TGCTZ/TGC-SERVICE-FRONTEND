...
const formSchema = z.object({
  ...
  product_category_id: z.coerce.number({ error: 'Category is required.' }),
  product_status_id: z.coerce.number({ error: 'Status is required.' }),
  brand_id: z.coerce.number().optional(),
  unit_of_measure_id: z.coerce.number().optional(),
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: currentRow
      ? {
          ...
          product_category_id: currentRow.product_category_id ?? undefined,
          product_status_id: currentRow.product_status_id ?? undefined,
          brand_id: currentRow.brand_id ?? undefined,
          unit_of_measure_id: currentRow.unit_of_measure_id ?? undefined,
          ...
          tags: currentRow.tags?.map((tag) => tag.id) ?? [],
        }
      : {
          currency: DEFAULT_CURRENCY,
          stock_quantity: 0,
