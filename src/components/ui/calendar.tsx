...
/** A date-picker calendar. Usually reached through `components/date-picker.tsx` rather than directly. */
function Calendar({
  className,
  classNames,
...
/** A single day cell, handling selected, today and outside-month states. */
