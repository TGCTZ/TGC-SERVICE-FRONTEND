...
/** A menu opened by a trigger. Controlled via `open`/`onOpenChange`. */
...
/** Renders the menu at the document root, escaping parent overflow and stacking contexts. */
...
/** Opens the menu. Use `asChild` to keep your own control. */
...
/** One action. `variant='destructive'` tints it; `inset` aligns it with items that have icons. */
...
/** A togglable item, for options that are independently on or off. */
...
/** A set of mutually exclusive items. */
...
/** One option in a `DropdownMenuRadioGroup`. */
...
/** A non-interactive heading within the menu. */
...
/** A keyboard-shortcut hint, aligned to the trailing edge. Display only — it binds nothing. */
...
/** Opens a submenu on hover or focus. */
